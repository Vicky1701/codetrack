...
const AddProblemForm = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const newProblem = {
        ...formData,
        solvedDates: [{ date: new Date().toISOString(), timeSpent: null, rating: null }],
        revisionCount: 0,
        lastRevised: null,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 sm:p-6 w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Add New Problem</h2>
          <button
            onClick={onClose}
